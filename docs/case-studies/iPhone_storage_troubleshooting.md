---
layout: default
title: Troubleshoot iPhone Storage Issues
---

# Troubleshooting: iPhone Storage Full

When you own an iPhone and take many photos and videos, the **iPhone Storage Full** message may appear. This happens when the media and saved files on your iPhone exceed the available storage.
...
### Step 1: Create and sign in to a cloud storage account

Create a cloud storage account such as [Google Photos](https://photos.google.com). Once created, sign in to the account on your iPhone.
...
2. Under **RECOMMENDATIONS**, tap one of the following options:

     ![iPhone Storage](/images/iPhone_Screenshot.png)

   - **Offload Unused Apps:** Automatically offloads rarely used apps while retaining their data. This option temporarily turns off an app, which can be reinstalled later if needed. The app will also disappear from the home screen.

     <div class="warning">
     <strong>Warning</strong>
     Once enabled, this option cannot be turned off. To manually select which apps to offload instead, proceed to Step 5.
     </div>
...
- [Apple iPhone website](https://www.apple.com/iphone/)
- [Jigxor Tutorials on YouTube](https://www.youtube.com/watch?v=Bf5gDXfoXJ0)
