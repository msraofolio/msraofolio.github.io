...
- 15+ years in fintech, SaaS, and internal tooling  
...
- **API & Integration Documentation**  
  Clear, scenario-driven guides that help developers build faster and with confidence.
...
- **Troubleshooting & Operational Guides**  
  Practical, actionable content that accelerates issue resolution.

---

## Featured Work

- [API Integration Case Study](case-studies/api-integration.md)  
- [Troubleshooting Guide](case-studies/troubleshooting-guide.md)  
...
If you're building something complex and need documentation that scales with your product, I’d love to collaborate.
